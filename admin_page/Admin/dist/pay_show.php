            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">ชำระเงินแล้ว</h4>
                                <br>
                                <?php
                                $sql_ord_script = "SELECT * FROM bk_ord_orders WHERE ord_status IN ('เตรียมจัดส่งสินค้า', 'อยู่ระหว่างการขนส่ง') ORDER BY ord_date DESC";
                                $ord_result = mysqli_query($proj_connect, $sql_ord_script) or die(mysqli_connect_error());

                                $sql_fnd_script = "SELECT * FROM bk_fnd_finder WHERE fnd_status IN ('เตรียมจัดส่งสินค้า', 'อยู่ระหว่างการขนส่ง') ORDER BY fnd_date DESC";
                                        ...
                                        <tbody>
                                            ...
                                            while ($fnd_row_result = mysqli_fetch_assoc($fnd_result)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="finder_address_form.php" method="POST">
