                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card" alert-danger>
                                <div class="card-body alert-danger">
                                    ...
                                    <br>
                                    <form action="product_promotion_delete.php" class="parsley-examples" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="prp_name" parsley-trigger="change" class="form-control alert-danger" id="prp_name" value="<?php echo $prp_row_result['prp_name'] ?>" readonly />
                                            <label for="prd_detail" class="form-label">รายละเอียดโปรโมชั่น</label>
                                            <textarea name="prd_detail" parsley-trigger="change" class="form-control alert-danger" id="prd_detail" rows="4" readonly><?php echo $prp_row_result['prp_detail'] ?></textarea>
                                            <label for="prp_discount" class="form-label">ส่วนลด</label>
                                            <input type="number" name="prp_discount" parsley-trigger="change" class="form-control alert-danger" id="prp_discount" value="<?php echo $prp_row_result['prp_discount'] ?>" readonly />
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control alert-danger" id="prp_start" type="date" name="prp_start" value="<?php echo $prp_row_result['prp_start'] ?>" readonly>
                                            ...
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control alert-danger" id="prp_end" type="date" name="prp_end" value="<?php echo $prp_row_result['prp_end'] ?>" readonly>
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body bg-danger">
                                                    <div class="text-center">
                                                        ...
                                                        <p class="mt-3 text-white">คุณแน่ใจว่าจะโปรโมชันนี้?</p>
                                                        <form action="product_promotion_delete.php" method="POST">
                                                            <input type="text" hidden id="prp_id" name="prp_id" value="<?php echo $prp_row_result['prp_id'] ?>">
