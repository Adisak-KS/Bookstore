				...
				<div class="col-lg-12">
					<div class="breadcrumbs-menu">
						<ul>
							...
							<li><a href="#" class="active">ลืมรหัสผ่าน</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="offset-lg-3 col-lg-6 col-md-12 col-12">
					<div class="login-form">
						<form method="POST" id="login_form" class="needs-validation" novalidate action="chang_pwd_email.php">
							<div class="single-login">
								<label>อีเมล <span class="text-danger">*</span></label>
								<input type="email" id="login_input" name="login_input" maxlength="50" placeholder="ใส่อีเมลของคุณ" class="form-control" required>
							...
							<div class="">
								...
								<button type="submit" style="width: 50%;" name="addaddressbtn" class="btn btn-sqr">ยืนยัน</button>
								<br><br>
