...
$sql_script = "SELECT * FROM bk_prd_product WHERE pty_id = " . $edit_id;
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
                                ...
                                <div class="card-body alert-danger">
                                    ...
                                    <form action="#" method="POST" id="productForm">
                                        ...
                                        ?>
                                            ...
                                            <br>
                                            <div class="text-end">
                                                <button type="button" class="btn btn-secondary waves-effect btn-sm" onclick="window.location.href='product_type_delete_form.php'">ย้อนกลับ</button>
    ...
    <script>
        document.getElementById('productForm').addEventListener('submit', function(event) {
            ...
            var url = 'product_delete_group.php?location=pty&' + queryString;
            //var url = '#?' + queryString;
