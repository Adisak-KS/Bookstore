                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">รายละอียดประเภทสินค้า</h4>
                                    <br>
                                    <form action="product_type_edit.php" class="parsley-examples" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="pty_detail" parsley-trigger="change" class="form-control" id="pty_detail" readonly rows="4"><?php echo $pty_row_result['pty_detail'] ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="pty_show" class="form-label">แสดงสินค้า</label>
                                                <select name="pty_show" parsley-trigger="change" class="form-select" id="pty_show" disabled>
