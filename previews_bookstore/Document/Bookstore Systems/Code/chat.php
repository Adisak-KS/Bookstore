...
<body class="home-1">
				...
				<div class="col-lg-12">
					<div class="breadcrumbs-menu">
						<ul>
							...
							<li><a href="#" class="active">คุยกับผู้ดูแล</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="cart-main-area mb-70">
		<div class="container">
			<div class="row">
				<form action="finder_add.php" method="POST" enctype="multipart/form-data" name="finder_form" id="finder_form">
					<div class="row">
							...
							<div class="checkbox-form">
								<div class="row">
									...
									<div class="col-lg-12 col-md-12 col-12">
										<div class="checkout-form-list">
											<label>เล่มที่ </label>
											<input type="number" name="fnd_volumn" id="fnd_volumn" placeholder="หนังสือของคุณเล่มที่เท่าไหร่ ?" required>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-12">
										<div class="checkout-form-list">
											<label>รูปภาพประกอบ </label>
											<input type="file" required name="fnd_img" id="fnd_img">
										</div>
									</div>
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="wc-proceed-to-checkout">
						<ul>
							...
							<li><a href="index.php" style="background-color: gray;">ย้อนกลับ</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-12">
