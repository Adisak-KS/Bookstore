					...
					<div class="new-book-area ptb-50">
						...
						<div class="tab-active-3 owl-carousel">
							...
							foreach ($grouped_products as $group) {
								// ตรวจสอบว่ากลุ่มมีสินค้าหรือไม่
								if (!empty($group)) {
							?>
									<div class="tab-total">
										<?php
										foreach ($group as $product_row) {
										?>
											<!-- single-product-start -->
											<div class="product-wrapper mb-40">
												<div class="product-img">
													<a href="product-details.php?prd_id=<?php echo base64_encode($product_row['prd_id']); ?>">
														<img style="width:; height: 250px;" src="prd_img/<?php echo $product_row['prd_img']; ?>" alt="book" class="primary" />
													</a>
													<!-- ตรวจสอบโปรโมชั่น -->
													<?php
                                ...
                                WHERE bk_prd_promotion.prd_id = " . $product_row['prd_id'];
													...
													<div class="product-flag">
														<ul>
															<li><span class="sale">ใหม่</span></li>
												...
												<div class="product-link">
													<div class="product-button">
														<a href="product-details.php?prd_id=<?php echo base64_encode($product_row['prd_id']); ?>" title="Add to cart">รายละเอียด</a>
													</div>
