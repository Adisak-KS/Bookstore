...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2024 at 06:35 PM
...
CREATE TABLE `bk_auth_admin` (
  `adm_id` int(11) NOT NULL COMMENT 'รหัสผู้ดูแล',
  `stf_id` varchar(250) NOT NULL COMMENT 'รหัสพนักงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ผู้ดูแล';
...
CREATE TABLE `bk_auth_member` (
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `mmb_username` varchar(50) NOT NULL COMMENT 'ชื่อผู้ใช้สมาชิก',
  `mmb_password` varchar(250) NOT NULL COMMENT 'รหัสผ่านสมาชิก',
  `mmb_firstname` varchar(50) NOT NULL COMMENT 'ชื่อจริงสมาชิก',
  `mmb_lastname` varchar(50) NOT NULL COMMENT 'นามสกุลสมาชิก',
  `mmb_email` varchar(50) NOT NULL COMMENT 'อีเมลสมาชิก',
  `mmb_coin` int(11) NOT NULL DEFAULT 0 COMMENT 'เหรียญสมาชิก',
  `mmb_profile` varchar(50) NOT NULL DEFAULT 'avatar.png' COMMENT 'รูปประจำตัวสมาชิก'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='สมาชิก';
...
(109, 'Adisak123', '$2y$10$VLXHa.yvmCklTzt1GPDSC.DsP6hGYOcW9fHpLUvoynQ9pdAqfD4aa', 'Adisak', 'Khongsuk', 'adisak@gmail.com', 0, 'avatar.png');
...
CREATE TABLE `bk_auth_sale` (
  `sle_id` int(11) NOT NULL COMMENT 'รหัสเซล',
  `stf_id` varchar(250) NOT NULL COMMENT 'รหัสพนักงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ฝ่ายขาย';
...
CREATE TABLE `bk_auth_staff` (
  `stf_id` int(11) NOT NULL COMMENT 'รหัสพนักงาน',
  `stf_username` varchar(50) NOT NULL COMMENT 'ชื่อผู้ใช้หนักงาน',
  `stf_password` varchar(250) NOT NULL COMMENT 'รหัสผ่านพนักงาน',
  `stf_firstname` varchar(50) NOT NULL COMMENT 'ชื่อจริงพนักงาน',
  `stf_lastname` varchar(50) NOT NULL COMMENT 'นามสกุลพนักงาน',
  `stf_email` varchar(50) NOT NULL COMMENT 'อีเมลพนักงาน',
  `stf_coin` int(11) NOT NULL DEFAULT 0 COMMENT 'เหรียญพนักงาน##',
  `stf_profile` varchar(100) NOT NULL DEFAULT 'avatar.png' COMMENT 'รูปประจำตัวพนักงาน',
  `stf_active` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'สถานะพนักงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='พนักงาน';
...
(41, 'superadmin', '$2y$10$QIEgXKkeEqzrU010coWS6u2DGy6Tl7kBHIsCYB5M5JLyILRjBCl82', 'ผู้ดูแลระบบสูงสุด', '.', 'superadmin@sup.sup', 0, '663b84d5b2c75_2560px-Tiligul_liman_5_Mb.jpg', 1),
...
(79, 'Admin1', '$2y$10$zazvhFxSRE6pV3XOYZy4X.Y.KpSX1NJc/ErJCbXuw6uIpOgobOx8S', 'admin1', 'admin1', 'admin1@gmail.com', 0, 'avatar.png', 1);
...
CREATE TABLE `bk_auth_super_admin` (
  `supadm_id` int(11) NOT NULL COMMENT 'รหัสผู้ดูแลขั้นสูง',
  `stf_id` int(11) NOT NULL COMMENT 'รหัสพนักงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ผู้ดูแลขั้นสูง';
...
CREATE TABLE `bk_fnd_finder` (
  `fnd_id` int(11) NOT NULL COMMENT 'รหัสรายการหาหนังสือ',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `fnd_date` datetime NOT NULL COMMENT 'วันที่รายการหาหนังสือ',
  `fnd_name` varchar(30) DEFAULT NULL COMMENT 'ชื่อหนังสือรายการหาหนังสือ',
  `fnd_author` varchar(50) DEFAULT NULL COMMENT 'ชื่อผู้แต่งรายการหาหนังสือ',
  `fnd_publisher` varchar(30) DEFAULT NULL COMMENT 'สำนักพิมพ์รายการหาหนังสือ',
  `fnd_volumn` varchar(20) NOT NULL COMMENT 'หมายเลขเล่มรายการหาหนังสือ',
  `fnd_img` varchar(250) DEFAULT NULL COMMENT 'รูปประกอบรายการหาหนังสือ',
  `fnd_status` varchar(50) NOT NULL DEFAULT 'รอการตรวจสอบ' COMMENT 'สถานะรายการหาหนังสือ',
  `fnd_price` int(11) NOT NULL DEFAULT 0 COMMENT 'ราคารายการหาหนังสือ',
  `pay_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางชำระเงิน',
  `shp_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางขนส่ง',
  `fnd_address` varchar(250) DEFAULT NULL COMMENT 'ที่อยู่จัดส่งรายการหาหนังสือ',
  `fnd_totalprice` decimal(10,2) DEFAULT NULL COMMENT 'ราคารวมรายการหาหนังสือ',
  `fnd_track` varchar(20) NOT NULL DEFAULT '-' COMMENT 'หมายเลขติดตามพัสดุรายการหาหนังสือ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='รายการตามหาหนังสือ';
...
CREATE TABLE `bk_fnd_item` (
  `fdit_id` int(11) NOT NULL COMMENT 'รหัสตอบกลับการหาหนังสือ',
  `fnd_id` int(11) NOT NULL COMMENT 'รหัสรานการหาหนังสือ',
  `fdit_detail` varchar(200) NOT NULL COMMENT 'รายละเอียดตอบกลับการหาหนังสือ',
  `fdit_status` varchar(50) NOT NULL COMMENT 'สถานะตอบกลับการหาหนังสือ',
  `fdit_name` varchar(100) NOT NULL COMMENT 'ชื่อหนังสือตอบกลับการหาหนังสือ',
  `fdit_author` varchar(100) NOT NULL COMMENT 'ผู้เขียนตอบกลับการหาหนังสือ',
  `fdit_publisher` varchar(50) NOT NULL COMMENT 'สำนักพิมพ์ตอบกลับการหาหนังสือ',
  `fdit_volumn` varchar(5) NOT NULL COMMENT 'หมายเลขเล่มตอบกลับการหาหนังสือ',
  `fdit_img` varchar(250) NOT NULL COMMENT 'รูปประกอบตอบกลับการหาหนังสือ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตอบกลับการหาหนังสือ';
...
CREATE TABLE `bk_fnd_notification` (
  `fdnf_id` int(11) NOT NULL COMMENT 'รหัสการชำระหารหาหนังสือ',
  `fnd_id` int(11) NOT NULL COMMENT 'รหัสรายการหาหนังสือ',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `pay_id` tinyint(4) NOT NULL COMMENT 'รหัสชำระเงิน',
  `fdnf_date` date NOT NULL COMMENT 'วันที่ชำระหารหาหนังสือ',
  `fdnf_amount` int(11) NOT NULL COMMENT 'จำนวนเงินการชำระหารหาหนังสือ',
  `fdnf_status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'สถานะการชำระหารหาหนังสือ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='แจ้งชำระรายการหาหนังสือ';
...
CREATE TABLE `bk_fnd_ntf_image` (
  `fnimg_id` int(11) NOT NULL COMMENT 'รหัสหลักฐานการชำระ',
  `fdnf_id` int(11) NOT NULL COMMENT 'รหัสราการหาหนังสือ',
  `fnimg_image` varchar(250) NOT NULL COMMENT 'รูปภาพหลักฐานการชำระเงิน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='หลักฐานการชำระเงินการหาหนังสือ';
...
CREATE TABLE `bk_mmb_address` (
  `addr_id` int(11) NOT NULL COMMENT 'รหัสที่อยู่สมาชิก',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `addr_detail` varchar(50) NOT NULL COMMENT 'รายละเอียดที่อยู่',
  `addr_provin` varchar(50) NOT NULL COMMENT 'จังหวัด',
  `addr_amphu` varchar(20) NOT NULL COMMENT 'อำเภอ',
  `addr_postal` char(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `addr_phone` char(20) NOT NULL COMMENT 'เบอร์ติดต่อ',
  `addr_name` varchar(50) NOT NULL COMMENT 'ชื่อผู้รับ',
  `addr_lastname` varchar(50) NOT NULL COMMENT 'นามสกุลผู้รับ',
  `addr_active` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'สถานะที่อยู่สมาชิก'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ที่อยู่สมาชิก';
...
CREATE TABLE `bk_mmb_coin_history` (
  `cnh_id` int(11) NOT NULL COMMENT 'รหัสประวัติการโอนเหรียญ',
  `mmb_id` int(11) DEFAULT NULL COMMENT 'รหัสสมาชิก',
  `cnh_income` int(11) DEFAULT NULL COMMENT 'จำนวนเหรียญที่ได้รับ',
  `cnh_outcome` int(11) DEFAULT NULL COMMENT 'จำนวนเหรียญที่ใช้',
  `cnh_coin` int(11) NOT NULL COMMENT 'จำเหรียญคงเหลือ',
  `cnh_detail` varchar(250) NOT NULL COMMENT 'รายละเอียดการโอนเหรียญ',
  `cnh_date` datetime NOT NULL COMMENT 'วันที่โอนเหรียญ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ประวัติการโอนและได้รับเหรียญ';
...
CREATE TABLE `bk_mmb_wishlist` (
  `wsl_id` int(11) NOT NULL COMMENT 'รหัสสิ่งที่อยากได้',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `prd_id` int(11) NOT NULL COMMENT 'รหัสสินค้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='สิ่งที่อยากได้';
...
CREATE TABLE `bk_ord_item` (
  `ordi_id` int(11) NOT NULL COMMENT 'รหัสไอเท็ม',
  `ord_id` int(11) NOT NULL COMMENT 'รหัสรายการซื้อ',
  `ordi_image` varchar(250) NOT NULL COMMENT 'รูปภาพไอเท็ม',
  `ordi_name` varchar(50) NOT NULL COMMENT 'ชื่อไอเท็ม',
  `ordi_detail` varchar(100) NOT NULL COMMENT 'รายละเอียดไอเท็ม',
  `ordi_quan` int(11) NOT NULL COMMENT 'จำนวนไอเท็ม',
  `ordi_total` decimal(10,2) NOT NULL COMMENT 'ราคารวมไอเท็ม',
  `ordi_coin` int(11) NOT NULL DEFAULT 0 COMMENT 'จำนวนเหรียญไอเท็ม'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='สินค้าในรายการสั่งซื้อ';
...
CREATE TABLE `bk_ord_notification` (
  `ntf_id` int(11) NOT NULL COMMENT 'รหัสการแจ้งชำระเงิน',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `pay_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางการชำระ',
  `ntf_date` datetime NOT NULL COMMENT 'วันที่ชำระ',
  `ntf_img` varchar(250) DEFAULT NULL COMMENT 'หลักฐานการชำระ',
  `ntf_amount` int(11) NOT NULL COMMENT 'ยอดเงินการชำระ',
  `ord_id` int(11) NOT NULL COMMENT 'รหัสรายการซื้อ',
  `ntf_status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'สถานะการแจ้งชำระ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='รายละเอียดการชำระเงิน';
...
CREATE TABLE `bk_ord_ntf_image` (
  `nimg_id` int(11) NOT NULL COMMENT 'รหัสหลักฐานชำระเงิน',
  `ntf_id` int(11) NOT NULL COMMENT 'รหัสการแจ้งชำระ',
  `nimg_img` varchar(250) NOT NULL COMMENT 'รูปหลักฐานการชำระ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='รูปภาพหละกฐานการชำระเงิน';
...
CREATE TABLE `bk_ord_orders` (
  `ord_id` int(11) NOT NULL COMMENT 'รหัสรายการซื้อ',
  `ord_date` datetime NOT NULL COMMENT 'เวลาสั่งซื้อ',
  `ord_amount` decimal(10,2) NOT NULL COMMENT 'ราคารายการสั่งซื้อ',
  `ord_address` varchar(255) NOT NULL COMMENT 'ที่อยู่จัดส่งราการซื้อ',
  `ord_payment` varchar(50) NOT NULL COMMENT 'รหัสช่องทางชำระ',
  `ord_status` varchar(50) NOT NULL COMMENT 'สถานะรายการสั่งซื้อ',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `ord_detail` varchar(250) NOT NULL COMMENT 'รายละเอียดรายการสั่งซื้อ',
  `ord_coin` int(11) NOT NULL COMMENT 'เหรียญที่ได้รับ',
  `shp_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางชำระ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='รายการสั่งซื้อ';
...
CREATE TABLE `bk_ord_payment` (
  `pay_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางชำระเงิน',
  `pay_name` varchar(30) NOT NULL COMMENT 'ชื่อช่องทางชำระเงิน',
  `pay_detail` varchar(50) NOT NULL COMMENT 'รายละเอียดช่องทางชำระเงิน',
  `pay_logo` varchar(250) DEFAULT NULL COMMENT 'โลโก้ช่องทางชำระเงิน',
  `pay_img` varchar(100) DEFAULT NULL COMMENT 'รูปช่องทางชำระเงิน',
  `pay_show` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'แสดงช่องทางชำระเงิน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ช่องทางการชำระเงิน';
...
CREATE TABLE `bk_ord_shipping` (
  `shp_id` tinyint(4) NOT NULL COMMENT 'รหัสช่องทางขนส่ง',
  `shp_name` varchar(20) NOT NULL COMMENT 'ชื่อช่องทางขนส่ง',
  `shp_detail` varchar(50) NOT NULL COMMENT 'รายละเอียดช่องทางขนส่ง',
  `shp_price` int(11) NOT NULL COMMENT 'ราคาช่องทางขนส่ง',
  `shp_show` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'แสดงช่องทางขนส่ง'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ช่องทางการขนส่ง';
...
CREATE TABLE `bk_password_reset` (
  `prs_id` tinyint(4) NOT NULL,
  `mmb_email` varchar(100) NOT NULL,
  `prs_token` varchar(250) NOT NULL,
...
CREATE TABLE `bk_prd_comment` (
  `cmm_id` int(11) NOT NULL COMMENT 'รหัสรีวิว',
  `prd_id` int(11) NOT NULL COMMENT 'รหัสสินค้า',
  `mmb_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก',
  `cmm_rating` int(11) NOT NULL DEFAULT 5 COMMENT 'คะแนนรีวิว',
  `cmm_detail` text DEFAULT NULL COMMENT 'รายละเอียดรีวิว',
  `cmm_date` datetime NOT NULL COMMENT 'วันที่รีวิว',
  `cmm_show` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'แสดงรีวิว'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ความคิดเห็นสินค้่า';
...
CREATE TABLE `bk_prd_image` (
  `prim_id` int(11) NOT NULL COMMENT 'รหัสรูปสินค้า***',
  `prim_name` char(100) NOT NULL COMMENT 'รูปสินค้า***',
  `prd_id` int(11) NOT NULL COMMENT 'รหัสสินค้า***'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='รูปสินค้า';
...
CREATE TABLE `bk_prd_product` (
  `prd_id` int(11) NOT NULL COMMENT 'รหัสสินค้า',
  `prd_img` char(50) NOT NULL DEFAULT 'book.jpg' COMMENT 'รูปสินค้า',
  `prd_name` char(50) NOT NULL COMMENT 'ชื่อสินค้า',
  `prd_detail` text NOT NULL COMMENT 'รายละเอียดสินค้า',
  `prd_price` int(11) NOT NULL COMMENT 'ราคาสินค้า',
  `prd_coin` int(11) NOT NULL COMMENT 'เหรียญสินค้า',
  `prd_qty` int(11) NOT NULL COMMENT 'จำนวนสินค้า',
  `prd_discount` int(11) NOT NULL DEFAULT 0 COMMENT 'ส่วนลดสินค้า',
  ...
  `publ_id` int(11) NOT NULL COMMENT 'รหัสสำนักพิมพ์',
  `prp_id` int(11) NOT NULL COMMENT 'รหัสสำนักพิมพ์'
...
CREATE TABLE `bk_prd_promotion` (
  `ppm_id` int(11) NOT NULL COMMENT 'รหัสสินค้าโปรโมชัน',
  `prp_id` int(11) NOT NULL COMMENT 'รหัสโปรโมชัน',
  `prd_id` int(11) NOT NULL COMMENT 'รหัสสินค้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='สินค้าโปรโมชัน';
...
CREATE TABLE `bk_prd_publisher` (
  `publ_id` int(11) NOT NULL COMMENT 'รหัสสำนักพิมพ์',
  `publ_name` char(50) NOT NULL COMMENT 'ชื่อสำนักพิมพ์',
  `publ_detail` char(50) NOT NULL COMMENT 'รายละเอียดสำนักพิมพ์'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='สำนักพิมพ์';
...
CREATE TABLE `bk_prd_type` (
  `pty_id` int(11) NOT NULL COMMENT 'รหัสประเภทสินค้า',
  `pty_name` char(20) NOT NULL COMMENT 'ชื่อประเภทสินค้า',
  `pty_detail` char(50) NOT NULL COMMENT 'รายละเอียดประเภทสินค้า',
  `pty_show` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'แสดงประเภทสินค้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ประเภทสินค้า';
...
CREATE TABLE `bk_promotion` (
  `prp_id` int(11) NOT NULL COMMENT 'รหัสโปรโมชัน',
  `prp_name` char(50) NOT NULL COMMENT 'ชื่อโปรโมชัน',
  `prp_detail` text NOT NULL COMMENT 'รายละเอียดโปรโมชัน',
  `prp_discount` int(11) NOT NULL COMMENT 'ส่วนลดโปรโมชัน',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='โปรโมชันสินค้า';
...
CREATE TABLE `bk_province` (
  `prov_id` int(11) NOT NULL COMMENT 'รหัสจังหวัด',
  `prov_name` varchar(255) NOT NULL COMMENT 'ชื่อจังหวัด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='จังหวัด';
...
CREATE TABLE `bk_setting` (
  `set_id` int(11) NOT NULL COMMENT 'รหัสตังค่า',
  `set_name` varchar(255) NOT NULL COMMENT 'ชื่อการตั้งค่า',
  `set_detail` text DEFAULT NULL COMMENT 'ชื่อรูปภาพ, ข้อความที่แสดง'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตั้งค่าเว็บไซต์';
...
CREATE TABLE `bk_set_banner` (
  `bnn_id` tinyint(4) NOT NULL COMMENT 'ไอดีบานเนอร์',
  `bnn_name` varchar(50) NOT NULL COMMENT 'ชื่อบานเนอร์',
  `bnn_image` varchar(250) NOT NULL COMMENT 'รายละเอียดรูปภาพ',
  `bnn_link` varchar(250) NOT NULL DEFAULT '#' COMMENT 'ลิ้งค์บานเนอร์',
  `bnn_show` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'แสดงบานเนอร์',
  `bnn_order` int(11) NOT NULL DEFAULT 0 COMMENT 'ลำดับการเรียงสไลด์โชว์'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='บานเนอร์โฆษณา';
...
--
-- Indexes for table `bk_auth_admin`
--
ALTER TABLE `bk_auth_admin`
  ADD PRIMARY KEY (`adm_id`),
  ADD UNIQUE KEY `stf_id` (`stf_id`);

--
-- Indexes for table `bk_auth_member`
--
ALTER TABLE `bk_auth_member`
  ADD PRIMARY KEY (`mmb_id`);

--
-- Indexes for table `bk_auth_sale`
--
ALTER TABLE `bk_auth_sale`
  ADD PRIMARY KEY (`sle_id`);

--
-- Indexes for table `bk_auth_staff`
--
ALTER TABLE `bk_auth_staff`
  ADD PRIMARY KEY (`stf_id`);

--
-- Indexes for table `bk_auth_super_admin`
--
ALTER TABLE `bk_auth_super_admin`
  ADD PRIMARY KEY (`supadm_id`),
  ADD UNIQUE KEY `stf_id` (`stf_id`);

--
-- Indexes for table `bk_fnd_finder`
--
ALTER TABLE `bk_fnd_finder`
  ADD PRIMARY KEY (`fnd_id`),
  ADD KEY `mmb_id` (`mmb_id`),
  ADD KEY `pay_id` (`pay_id`),
  ADD KEY `ship_id` (`shp_id`);

--
-- Indexes for table `bk_fnd_item`
--
ALTER TABLE `bk_fnd_item`
  ADD PRIMARY KEY (`fdit_id`),
  ADD KEY `fnd_id` (`fnd_id`);

--
-- Indexes for table `bk_fnd_notification`
--
ALTER TABLE `bk_fnd_notification`
  ADD PRIMARY KEY (`fdnf_id`),
  ADD KEY `pay_id` (`pay_id`),
  ADD KEY `fnd_id` (`fnd_id`),
  ADD KEY `mmb_id` (`mmb_id`);

--
-- Indexes for table `bk_fnd_ntf_image`
--
ALTER TABLE `bk_fnd_ntf_image`
  ADD PRIMARY KEY (`fnimg_id`),
  ADD KEY `fdnf_id` (`fdnf_id`);

--
-- Indexes for table `bk_mmb_address`
--
ALTER TABLE `bk_mmb_address`
  ADD PRIMARY KEY (`addr_id`),
  ADD UNIQUE KEY `addr_id` (`addr_id`),
  ADD KEY `mmb_id` (`mmb_id`) USING BTREE;

--
-- Indexes for table `bk_mmb_coin_history`
--
ALTER TABLE `bk_mmb_coin_history`
  ADD PRIMARY KEY (`cnh_id`),
  ADD KEY `mmb_id` (`mmb_id`);

--
-- Indexes for table `bk_mmb_wishlist`
--
ALTER TABLE `bk_mmb_wishlist`
  ADD PRIMARY KEY (`wsl_id`),
  ADD KEY `mmb_id` (`mmb_id`),
  ADD KEY `prd_id` (`prd_id`);

--
-- Indexes for table `bk_ord_item`
--
ALTER TABLE `bk_ord_item`
  ADD PRIMARY KEY (`ordi_id`),
  ADD KEY `ord_id` (`ord_id`);

--
-- Indexes for table `bk_ord_notification`
--
ALTER TABLE `bk_ord_notification`
...
--
-- Indexes for table `bk_ord_ntf_image`
--
ALTER TABLE `bk_ord_ntf_image`
  ADD PRIMARY KEY (`nimg_id`),
  ADD KEY `ntf_id` (`ntf_id`);

--
-- Indexes for table `bk_ord_orders`
--
ALTER TABLE `bk_ord_orders`
  ADD PRIMARY KEY (`ord_id`),
  ADD KEY `mmb_id` (`mmb_id`),
  ADD KEY `shp_id` (`shp_id`);

--
-- Indexes for table `bk_ord_payment`
--
ALTER TABLE `bk_ord_payment`
  ADD PRIMARY KEY (`pay_id`);

--
-- Indexes for table `bk_ord_shipping`
--
ALTER TABLE `bk_ord_shipping`
  ADD PRIMARY KEY (`shp_id`);

--
-- Indexes for table `bk_password_reset`
--
ALTER TABLE `bk_password_reset`
  ADD PRIMARY KEY (`prs_id`);

--
-- Indexes for table `bk_prd_comment`
--
ALTER TABLE `bk_prd_comment`
  ADD PRIMARY KEY (`cmm_id`),
  ADD KEY `prd_id` (`prd_id`) USING BTREE,
  ADD KEY `mmb_id` (`mmb_id`) USING BTREE;

--
-- Indexes for table `bk_prd_image`
--
ALTER TABLE `bk_prd_image`
  ADD PRIMARY KEY (`prim_id`),
  ADD KEY `prd_id` (`prd_id`);

--
-- Indexes for table `bk_prd_product`
--
ALTER TABLE `bk_prd_product`
  ADD PRIMARY KEY (`prd_id`),
  ADD KEY `pty_id` (`pty_id`) USING BTREE,
  ADD KEY `publ_id` (`publ_id`);

--
-- Indexes for table `bk_prd_promotion`
--
ALTER TABLE `bk_prd_promotion`
  ADD PRIMARY KEY (`ppm_id`),
  ADD KEY `prp_id` (`prp_id`),
  ADD KEY `prd_id` (`prd_id`);

--
-- Indexes for table `bk_prd_publisher`
--
ALTER TABLE `bk_prd_publisher`
  ADD PRIMARY KEY (`publ_id`);

--
-- Indexes for table `bk_prd_type`
--
ALTER TABLE `bk_prd_type`
  ADD PRIMARY KEY (`pty_id`);

--
-- Indexes for table `bk_promotion`
--
ALTER TABLE `bk_promotion`
  ADD PRIMARY KEY (`prp_id`);

--
-- Indexes for table `bk_province`
--
ALTER TABLE `bk_province`
...
--
-- Indexes for table `bk_set_banner`
--
ALTER TABLE `bk_set_banner`
  ADD PRIMARY KEY (`bnn_id`);
...
--
-- AUTO_INCREMENT for table `bk_auth_admin`
--
ALTER TABLE `bk_auth_admin`
  MODIFY `adm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ดูแล', AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `bk_auth_member`
--
ALTER TABLE `bk_auth_member`
  MODIFY `mmb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสมาชิก', AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT for table `bk_auth_sale`
--
ALTER TABLE `bk_auth_sale`
  MODIFY `sle_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเซล', AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `bk_auth_staff`
--
ALTER TABLE `bk_auth_staff`
  MODIFY `stf_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสพนักงาน', AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT for table `bk_auth_super_admin`
--
ALTER TABLE `bk_auth_super_admin`
  MODIFY `supadm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ดูแลขั้นสูง', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `bk_fnd_finder`
--
ALTER TABLE `bk_fnd_finder`
  MODIFY `fnd_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรายการหาหนังสือ', AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `bk_fnd_item`
--
ALTER TABLE `bk_fnd_item`
  MODIFY `fdit_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตอบกลับการหาหนังสือ', AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `bk_fnd_notification`
--
ALTER TABLE `bk_fnd_notification`
  MODIFY `fdnf_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการชำระหารหาหนังสือ', AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `bk_fnd_ntf_image`
--
ALTER TABLE `bk_fnd_ntf_image`
  MODIFY `fnimg_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหลักฐานการชำระ', AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `bk_mmb_address`
--
ALTER TABLE `bk_mmb_address`
  MODIFY `addr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสที่อยู่สมาชิก', AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `bk_mmb_coin_history`
--
ALTER TABLE `bk_mmb_coin_history`
  MODIFY `cnh_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสประวัติการโอนเหรียญ', AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `bk_mmb_wishlist`
--
ALTER TABLE `bk_mmb_wishlist`
  MODIFY `wsl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสิ่งที่อยากได้', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `bk_ord_item`
--
ALTER TABLE `bk_ord_item`
  MODIFY `ordi_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสไอเท็ม', AUTO_INCREMENT=185;

--
-- AUTO_INCREMENT for table `bk_ord_notification`
--
ALTER TABLE `bk_ord_notification`
  MODIFY `ntf_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการแจ้งชำระเงิน', AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT for table `bk_ord_ntf_image`
--
ALTER TABLE `bk_ord_ntf_image`
  MODIFY `nimg_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหลักฐานชำระเงิน', AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `bk_ord_orders`
--
ALTER TABLE `bk_ord_orders`
  MODIFY `ord_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรายการซื้อ', AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `bk_ord_payment`
--
ALTER TABLE `bk_ord_payment`
  MODIFY `pay_id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสช่องทางชำระเงิน', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `bk_ord_shipping`
--
ALTER TABLE `bk_ord_shipping`
  MODIFY `shp_id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสช่องทางขนส่ง', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `bk_password_reset`
--
ALTER TABLE `bk_password_reset`
  MODIFY `prs_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `bk_prd_comment`
--
ALTER TABLE `bk_prd_comment`
  MODIFY `cmm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรีวิว', AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `bk_prd_image`
--
ALTER TABLE `bk_prd_image`
  MODIFY `prim_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรูปสินค้า***', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `bk_prd_product`
--
ALTER TABLE `bk_prd_product`
  MODIFY `prd_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสินค้า', AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT for table `bk_prd_promotion`
--
ALTER TABLE `bk_prd_promotion`
  MODIFY `ppm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสินค้าโปรโมชัน', AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `bk_prd_publisher`
--
ALTER TABLE `bk_prd_publisher`
  MODIFY `publ_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสำนักพิมพ์', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `bk_prd_type`
--
ALTER TABLE `bk_prd_type`
  MODIFY `pty_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสประเภทสินค้า', AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT for table `bk_promotion`
--
ALTER TABLE `bk_promotion`
  MODIFY `prp_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสโปรโมชัน', AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `bk_province`
--
ALTER TABLE `bk_province`
  MODIFY `prov_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสจังหวัด', AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `bk_setting`
--
ALTER TABLE `bk_setting`
  MODIFY `set_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตังค่า', AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `bk_set_banner`
--
ALTER TABLE `bk_set_banner`
  MODIFY `bnn_id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีบานเนอร์', AUTO_INCREMENT=22;
...
--
ALTER TABLE `bk_prd_product`
  ADD CONSTRAINT `bk_prd_product_ibfk_1` FOREIGN KEY (`pty_id`) REFERENCES `bk_prd_type` (`pty_id`),
  ADD CONSTRAINT `bk_prd_product_ibfk_2` FOREIGN KEY (`publ_id`) REFERENCES `bk_prd_publisher` (`publ_id`);

--
-- Constraints for table `bk_prd_promotion`
--
ALTER TABLE `bk_prd_promotion`
  ADD CONSTRAINT `bk_prd_promotion_ibfk_1` FOREIGN KEY (`prp_id`) REFERENCES `bk_promotion` (`prp_id`),
  ADD CONSTRAINT `bk_prd_promotion_ibfk_2` FOREIGN KEY (`prd_id`) REFERENCES `bk_prd_product` (`prd_id`);
COMMIT;
